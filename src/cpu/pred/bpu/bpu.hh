...
class bpu
{
    public:
        ...
        ubtb_response_t run_bpu1(bpu_addr_t pc);
        btb_response_t run_bpu2(bpu_addr_t pc, tage_response_t tage_response,
                                tt_bank_response_t tt_response,
                                ras_response_t ras_response);
        bpu_redirect_t run_bpu3(bpu_addr_t pc,
                                const btb_response_t& bpu2_response,
        ...
        void update_ubtb(bpu_addr_t pc, const ubtb_entry_t& entry);
    ...
    private:
        ...
        int create_bpu2_speculative_node(bpu_addr_t pc,
        ...
        void mark_ubtb_fill(int speculative_id, bpu_addr_t pc);
